                ...
                <div className="container flex h-14 items-center justify-between">
                    <div className="flex items-center gap-8">
                        <a href="/" className="flex items-center gap-2 text-lg font-semibold gradient-text">
                            <img src={logo} alt="SoDAS Logo" className="h-6 w-6" />
                            SoDAS
                        </a>
            ...
            <main className="flex-1">
                ...
                <section id="home" className="container py-6">
                    <div className="flex flex-col items-center text-center">
                        <div className="flex items-center justify-center mb-2">
                            <img src={hero} alt="SoDAS Hero" className="w-80 h-80" />
                        </div>
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            <div className="w-full max-w-5xl bg-[#1E293B]/30 rounded-lg p-8 border border-white/[0.08]">
                                <img
                                    ...
                                    alt="SoDAS Architecture Diagram"
                        ...
                        {[
                            {
                                ...
                                href: "https://t.me/SoDASSalesAgent_bot"
                            },
                            {
                                title: "Pro Tier",
                                price: "$19.99",
                ...
                <section id="contact" className="py-24 bg-[#0F172A]/50">
                    <div className="container space-y-12">
                        ...
                        <div className="flex justify-center">
                            <a href="https://t.me/SoDASSalesAgent_bot" target="_blank" rel="noopener noreferrer">
                ...
                <section className="container py-24 space-y-12">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://x.com/SoDASMemeWizard" target="_blank" rel="noopener noreferrer" className="group">
                        ...
                        <a href="https://warpcast.com/sodasmemewizard" target="_blank" rel="noopener noreferrer" className="group">
                            <Card className="bg-[#1E293B]/30 border-white/[0.08] hover:bg-[#1E293B]/50 transition-colors p-6">
                                <div className="flex flex-col items-center space-y-4">
                ...
                <section id="opensource" className="py-24 bg-[#0F172A]/50">
                    <div className="container space-y-12">
                        ...
                        <div className="flex justify-center gap-4">
                            <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/5" onClick={() => window.location.href = 'https://github.com/worksgoodcompany/sodas'}>
                                <img src={githubIcon} alt="GitHub" className="mr-2 h-4 w-4" />
                                Contribute on GitHub
                            </Button>
                            <Button variant="outline" size="lg" className="border-white/10 hover:bg-white/5" onClick={() => window.location.href = 'https://discord.gg/EFYm7WXrr'}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex flex-col items-center text-center">
                                <div className="flex items-center gap-2">
                                    <img src={logo} alt="SoDAS Logo" className="h-6 w-6" />
                                    <h3 className="text-lg font-semibold gradient-text">SoDAS</h3>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-center gap-4 mt-4">
                                ...
                                <a
                                    href="https://github.com/worksgoodcompany/sodas"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
